...
export const getUserProfileUrl = (
  maND,
  userPath = "../user/otherUserProfile.html",
) => {
  if (!maND) return "";
  return `${userPath}?id=${encodeURIComponent(maND)}`;
};

export const saveLoginSession = ({
  token,
  refreshToken,
  avatarURL,
  rememberLogin,
...
export const getTimeBasedGreeting = (type = "home") => {
  ...
  const greetings = {
    home: {
      morning: [
        "Chào buổi sáng",
        "Bắt đầu ngày mới đầy năng lượng nhé",
        "Chúc buổi sáng tốt lành",
        "Ngày mới vui vẻ",
      ],
      afternoon: [
        "Chào buổi chiều",
        "Nghỉ ngơi một chút rồi học tiếp nhé",
        "Buổi chiều hiệu quả",
        "Chào buổi chiều nắng ấm",
      ],
      evening: [
        "Chào buổi tối",
        "Buổi tối an lành",
      ...
      night: [
        ...
        "Học khuya vất vả rồi",
        "Chúc bạn ngủ ngon sau khi học xong",
      ],
    },
    login: {
      morning: [
        "Chào ngày mới! Bắt đầu học thôi.",
        "Đăng nhập thành công! Buổi sáng tốt lành.",
        "Chào buổi sáng năng lượng!",
      ],
      afternoon: [
        "Đăng nhập thành công! Chiều năng suất nhé.",
        "Chào buổi chiều! Cùng chia sẻ tài liệu nào.",
        "Đăng nhập thành công!",
      ],
      evening: [
        "Chào buổi tối! Bắt đầu học nhé.",
        "Đăng nhập thành công! Tối an lành.",
        "Buổi tối tuyệt vời để học tập!",
      ],
      night: [
        "Chăm chỉ quá! Đăng nhập thành công.",
        "Cú đêm à? Chúc bạn học tốt.",
        "Đăng nhập thành công! Nhớ giữ gìn sức khỏe nhé.",
      ],
    },
    logout: {
      morning: [
        "Đăng xuất thành công. Hẹn gặp lại nhé!",
        "Tạm biệt! Chúc một ngày vui vẻ.",
        "Hẹn gặp lại bạn sớm nhé!",
      ],
      afternoon: [
        "Đăng xuất thành công. Hẹn gặp lại nhé!",
        "Tạm biệt! Chúc một buổi chiều tốt lành.",
        "Nghỉ ngơi nhé, hẹn gặp lại!",
      ],
      evening: [
        "Tạm biệt! Chúc buổi tối ấm áp.",
        "Đăng xuất thành công. Nghỉ ngơi nhé!",
        "Hẹn gặp lại vào ngày mai!",
      ],
      night: [
        "Ngủ ngon nhé! Hẹn gặp lại.",
        "Khuya rồi, nghỉ ngơi thôi. Đăng xuất thành công!",
        "Tạm biệt cú đêm, ngủ ngon!",
      ],
    },
  };
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      const checkedBoxes = document.querySelectorAll(
        ".export-col-checkbox:checked",
      );
      const selectedCols = Array.from(checkedBoxes).map((cb) => cb.value);
      if (selectedCols.length === 0) {
        Swal.showValidationMessage(
          "Bạn phải chọn ít nhất một cột để xuất báo cáo.",
        );
        return false;
      }
      return selectedCols;
