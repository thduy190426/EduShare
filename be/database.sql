...
CREATE TABLE IF NOT EXISTS LICH_SU_XU (
    MaGD INT AUTO_INCREMENT PRIMARY KEY,
    MaND INT NOT NULL,
    LoaiGiaoDich ENUM('NapXu', 'MuaTaiLieu', 'BanTaiLieu', 'TruXuAdmin') NOT NULL,
...
-- ==============================================
-- 4. TẠO INDEX ĐỂ TỐI ƯU HÓA HIỆU SUẤT TRUY VẤN
-- ==============================================

-- Index cho bảng TAILIEU
